...
\hypersetup{%
    pdftitle={Development of a comprehensive learning management system designed for computer science},
    pdfauthor={Bailin He},
    pdfkeywords={
...
\bibliographystyle{myplainnat}   % Default boring and almost useless number.
